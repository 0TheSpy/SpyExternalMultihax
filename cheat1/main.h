...
DWORD engine_dll_base, gameui_dll_base, vgui2_dll_base, vguimatsurface_dll_base, d3d9_dll_base, nvd3dum_dll_base, localplayer, ptr, cmdptr, aobconsole, aobcmdnum, enginedelta,
